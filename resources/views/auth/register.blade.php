                    ...
                    <div class="col-lg-4">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" @change="checkForEmailAvailability()" :class='{}'  v-model="email" type="email"
                            ...
                            <div class="form-group">
                                ...
                                <input id="password-confirm" type="password" v-model="password"
                    ...
                    axios.get('{{ route('api-register-check') }}', {
                        ...
                        .then(function(response) {
                            if (response.data == 'Available') {
                                self.$toasted.show(
                                    "Email Tersedia ! Silahkan lanjut langkah selanjutnya!", {
                                        position: "top-center",
                                        className: "rounded",
                                        duration: 1000,
                                    }
